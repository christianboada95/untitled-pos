...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'Inventario', icon: 'pi pi-fw pi-box', routerLink: ['/inventario'],
                items: [
                    {label: 'Productos', icon: 'pi pi-fw pi-box', routerLink: ['inventario/productos']},
                    {label: 'Servicios', icon: 'pi pi-fw pi-tag', routerLink: ['inventario/servicios'], target: '_blank'},
                ]
            },
